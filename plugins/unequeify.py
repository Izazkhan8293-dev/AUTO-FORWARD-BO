...
async def unequify(client, message):
    ...
    if not _bot:
        return await message.reply(
            "<b>Need userbot to do this process. Please add a userbot using /settings</b>"
        )
    ...
    try:
        ...
        await sts.edit(
            f"**please make your [userbot](t.me/{_bot['username']}) "
            "admin in target chat with full permissions**"
        )
